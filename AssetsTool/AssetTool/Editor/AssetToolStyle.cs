...
namespace AssetTool
{
    public class AssetToolStyle
    {
        public class Style
        {
            ...
            public GUIContent searchReferenceTitle = new GUIContent("查找关联引用");
            public GUIContent searchReferenceWaiting = new GUIContent("等待进行查找关联引用");
            public GUIContent searchReferenceNothing = new GUIContent("没有关联引用");
            public GUIContent searchReferenceHeaderContent2 = new GUIContent("关联引用");
            public GUIContent searchReferenceHeaderContent3 = new GUIContent("隶属");
