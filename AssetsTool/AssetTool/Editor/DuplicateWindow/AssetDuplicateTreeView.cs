...
namespace AssetTool
{
    public class AssetDuplicateTreeView : AssetTreeView
    {
        ...
        protected override void ContextClickedItem(int id)
        {
            ...
            menu.AddItem(AssetToolStyle.Get().dependenciesTitle, false, OnContextFindDependenciesActiveItem, item);
            menu.AddSeparator(String.Empty);
            menu.AddItem(AssetToolStyle.Get().duplicateContextOnlyUseThis, false, OnContextUseThisItem, item);
            menu.ShowAsContext();
        }
