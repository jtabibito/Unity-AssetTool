...
namespace AssetTool
{
    public class AssetDuplicateWindow : AssetBaseWindow
    {
        ...
        private void Awake()
        {
            titleContent = AssetToolStyle.Get().duplicateTitle;
        ...
        protected override void DrawGUI(GUIContent waiting, GUIContent nothing, bool expandCollapseComplex)
        {
            ...
            {
                base.DrawGUI(AssetToolStyle.Get().duplicateWaiting, AssetToolStyle.Get().duplicateNothing, false);
            }
        }
        ...
        protected override MultiColumnHeaderState CreateMultiColumnHeader()
        {
            var columns = new[]
            {
                ...
                {
                    headerContent = AssetToolStyle.Get().duplicateHeaderContent,
                ...
                new MultiColumnHeaderState.Column
                {
                    headerContent = AssetToolStyle.Get().duplicateHeaderContent2,
                    headerTextAlignment = TextAlignment.Left,
                    canSort = false,
                    width = 300,
                    minWidth = 100,
                ...
                new MultiColumnHeaderState.Column
                {
                    headerContent = AssetToolStyle.Get().duplicateHeaderContent3,
                    headerTextAlignment = TextAlignment.Left,
                    canSort = false,
                    width = 60,
                    minWidth = 60,
                ...
                new MultiColumnHeaderState.Column
                {
                    headerContent = AssetToolStyle.Get().duplicateHeaderContent4,
                    headerTextAlignment = TextAlignment.Left,
                    canSort = false,
                    width = 110,
                    minWidth = 60,
        ...
        {
            if (GUILayout.Button(AssetToolStyle.Get().duplicateManualAdd, EditorStyles.toolbarButton, GUILayout.Width(70f)))
            {
                m_ManualAdd = true;
            }
        }
