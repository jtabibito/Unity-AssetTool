...
namespace AssetTool
{
    public class AssetToolHandlerDemo
    {
        public AssetToolHandlerDemo()
        {
            AssetToolHandler.onDependenciesLoadDataMore += OnDependenciesLoadDataMore;
            AssetToolHandler.onDependenciesContextDraw += OnDependenciesContextDraw;
        }
